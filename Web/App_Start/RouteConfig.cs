...
namespace Web.App_Start
{
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapPageRoute("Account_ChangePassword", "account/change-password", "~/Account/ChangePassword.aspx");
            ...
            routes.MapPageRoute("User_Search_Json", "search/GetFilmSuggestions", "~/User/Search.aspx/GetFilmSuggestions");
            routes.MapPageRoute("User_Favote", "favote", "~/User/Favote.aspx");
            ...
            routes.MapPageRoute("Search_By_Tag", "films-by-tag/{tagId}", "~/User/SearchByTag.aspx");
