...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    height: 30px;
    background: #f7f547;
    color: #000000;">Top phim đánh giá cao nhất</h5>
                <div class="slick-multiItemSlider">
                  <% if (latestFilms != null)
   {
       foreach (FilmInfo filmInfo in latestFilms.OrderByDescending(s => s.scoreRating))
       { %>
    ...
    <div class="title-in">
        <div class="cate">
            <% foreach (CategoryInfo categoryOfFilm in filmInfo.Categories)
               { %>
            <span class="blue"><a href="<%= categoryOfFilm.url %>"><%= categoryOfFilm.name %></a></span>
            <% } %>
        </div>
...
<% }
    ...
    height: 30px;
    background: #d87171;
    color: #ffffff;">Những phim vừa mới ra mắt </h5>
                <div class="slick-multiItemSlider">
                    <% if (newFilms != null)
                        {
                            foreach (FilmInfo filmInfo in newFilms)
                            { %>
                    <div class="movie-item">
                        <div class="mv-img">
                            <a href="<% = filmInfo.url %>">
